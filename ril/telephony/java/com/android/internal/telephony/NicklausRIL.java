...
public class NicklausRIL extends RIL implements CommandsInterface {
    ...
    public NicklausRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        ...
        //mContext = context;
        Rlog.i("NicklausRIL", "Ctor1: context is " + mContext);
    ...
    public NicklausRIL(Context context, int preferredNetworkType,
        ...
        //mContext = context;
        Rlog.i("NicklausRIL", "Ctor2: context is " + mContext);
        mTelephonyManager = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
        mEccList = new MtkEccList();
    }
    ...
    iccIOForApp (int command, int fileid, String path, int p1, int p2, int p3,
        ...
        if (command == 0xc0 && p3 == 0) {
            Rlog.i("NicklausRIL", "Override the size for the COMMAND_GET_RESPONSE 0 => 15");
            p3 = 15;
        }
